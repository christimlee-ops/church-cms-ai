    ...
    <div className="min-h-screen bg-navy-500 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-heading font-bold text-white">Calvary</h1>
          <p className="text-gold-400 font-heading text-lg mt-1">Members Portal</p>
          <p className="text-navy-200 mt-1">Sign in to access the members area</p>
        </div>
