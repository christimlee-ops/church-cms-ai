...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "churches near me Chandler AZ",
    "Sunday worship Chandler",
    "Saturday worship Chandler",
    "Bible study Chandler Arizona",
    "Sunday school Chandler AZ",
    "church events Chandler AZ",
    "family church Chandler",
    "kids church programs Chandler",
    "Mornings with Mommy Chandler",
    "confirmation class Chandler AZ",
    "Lutheran church near me",
    "WELS church near me Arizona",
    "Christian church Chandler Gilbert Mesa",
    "worship service near me",
    "Bible study near me Chandler",
    "church community events near me",
    "Wisconsin Evangelical Lutheran Synod Arizona",
    "Pastor Martin Spaude",
    "church Gilbert AZ",
    "church Mesa AZ",
    "church Tempe AZ",
    "Lutheran church East Valley AZ",
  ],
  openGraph: {
